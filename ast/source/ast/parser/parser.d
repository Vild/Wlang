...
private:
	...
	Statement getOperatorStatement(Array!AttributeToken attr) {
		...
		if (has!(OperatorToken, OperatorType.BRACKET_OPEN)) {
			...
			get!OperatorToken;
			return new MathAssignStatement(this, attr, OperatorType.ADD_ASSIGN, getStatement(attr),
					new ConstantValueStatement(this, attr, 1));
		} else if (has!(OperatorToken, OperatorType.DECREMENT)) {
			get!OperatorToken;
			return new MathAssignStatement(this, attr, OperatorType.SUB_ASSIGN, getStatement(attr),
					new ConstantValueStatement(this, attr, 1));
		}
		return null;
	}
	...
	Statement getAfterOperatorStatement(Array!AttributeToken attr, Statement stmt) {
		if (has!(OperatorToken, OperatorType.PLUS) || has!(OperatorToken, OperatorType.MINUS) || has!(OperatorToken,
				OperatorType.ASTERISK) || has!(OperatorToken, OperatorType.SLASH) || has!(OperatorToken,
				OperatorType.LEFT_ROTATE) || has!(OperatorToken, OperatorType.RIGHT_ROTATE) || has!(OperatorToken,
				OperatorType.LEFT_SHIFT) || has!(OperatorToken, OperatorType.RIGHT_SHIFT) || has!(OperatorToken,
				OperatorType.DOUBLE_AND) || has!(OperatorToken, OperatorType.BIT_AND) || has!(OperatorToken,
				OperatorType.LOG_OR) || has!(OperatorToken, OperatorType.BIT_OR) || has!(OperatorToken,
				OperatorType.LOG_XOR) || has!(OperatorToken, OperatorType.BIT_XOR) || has!(OperatorToken, OperatorType.MODULO)) {
			auto d = get!(OperatorToken, "type");
			return new MathStatement(this, attr, d.type.Type, stmt, getStatement(attr));
		} else if (has!(OperatorToken, OperatorType.ADD_ASSIGN) || has!(OperatorToken, OperatorType.SUB_ASSIGN)
				|| has!(OperatorToken, OperatorType.MUL_ASSIGN) || has!(OperatorToken, OperatorType.DIV_ASSIGN) || has!(OperatorToken,
					OperatorType.LEFT_ROTATE_ASSIGN) || has!(OperatorToken, OperatorType.RIGHT_ROTATE_ASSIGN) || has!(OperatorToken,
					OperatorType.LEFT_SHIFT_ASSIGN) || has!(OperatorToken, OperatorType.RIGHT_SHIFT_ASSIGN) || has!(OperatorToken,
					OperatorType.LOG_AND_ASSIGN) || has!(OperatorToken, OperatorType.BIT_AND_ASSIGN) || has!(OperatorToken,
					OperatorType.LOG_OR_ASSIGN) || has!(OperatorToken, OperatorType.BIT_OR_ASSIGN) || has!(OperatorToken,
					OperatorType.LOG_XOR_ASSIGN) || has!(OperatorToken, OperatorType.BIT_XOR_ASSIGN) || has!(OperatorToken,
					OperatorType.MODULO_ASSIGN) || has!(OperatorToken, OperatorType.BIT_NOT_ASSIGN)) {
			auto d = get!(OperatorToken, "type");
			return new MathAssignStatement(this, attr, d.type.Type, stmt, getStatement(attr));
		} else if (has!(OperatorToken, OperatorType.EQUALS) || has!(OperatorToken, OperatorType.LESS_THAN_EQUAL)
				|| has!(OperatorToken, OperatorType.GREATER_THAN_EQUAL) || has!(OperatorToken, OperatorType.LESS_THAN)
				|| has!(OperatorToken, OperatorType.GREATER_THAN) || has!(OperatorToken, OperatorType.NOT_EQUALS)) {
			auto d = get!(OperatorToken, "type");
			return new MathAssignStatement(this, attr, d.type.Type, stmt, getStatement(attr));
		} else if (has!(OperatorToken, OperatorType.INCREMENT)) {
			get!OperatorToken;
			return new TriggerAfterStatement(this, attr, stmt, new MathAssignStatement(this, attr,
					OperatorType.ADD_ASSIGN, stmt, new ConstantValueStatement(this, attr, 1)));
		} else if (has!(OperatorToken, OperatorType.INCREMENT)) {
			get!OperatorToken;
			return new TriggerAfterStatement(this, attr, stmt, new MathAssignStatement(this, attr,
					OperatorType.SUB_ASSIGN, stmt, new ConstantValueStatement(this, attr, 1)));
		} else if (has!(OperatorToken, OperatorType.ASSIGN)) {
			get!OperatorToken;
			SymbolToken sym;
